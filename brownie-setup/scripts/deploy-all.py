...
def main():
    ...
    usd_token.mint('0xB09ecEe4335B97CbE76521c317081Bccf83d6190', 1_000_000e18, {'from': acct_adm})


def deployNewRound(_tge, _cliff, _duration, _slice, _price, market, acct_adm, start=1682010220, minOrderSize=1e18, maxOrderSize=10_000e18, revocable=False, permissionLess=True, isInternal=True):
